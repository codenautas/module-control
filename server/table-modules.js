...
module.exports = function (context) {
    ...
    return context.be.tableDefAdapt({
        ...
        sql: {
            ...
            from: `(select * from modules m left join (select distinct on (v.module) v.version, v.module version_module, v.cobertura, v.test_pass, v.insecurity_level from versions v order by v.module, v.version desc) v on (m.module = v.version_module) )`
        }
    }, context);
}